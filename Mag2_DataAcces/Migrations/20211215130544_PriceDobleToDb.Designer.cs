...
namespace Mag2_DataAcces.Migrations
{
    ...
    [Migration("20211215130544_PriceDobleToDb")]
    partial class PriceDobleToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mag2_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mag2_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mag2_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("PricePerQuantity")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Mag2_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mag2_Models.InquiryDetail", b =>
                {
                    b.HasOne("Mag2_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mag2_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Mag2_Models.InquiryHeader", b =>
                {
                    b.HasOne("Mag2_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Mag2_Models.OrderDetail", b =>
                {
                    b.HasOne("Mag2_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Mag2_Models.OrderHeader", b =>
                {
                    b.HasOne("Mag2_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
